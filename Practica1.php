...
necesarios">
<meta name="author" content="Ricardo Montoya Gómez">
...
<div class="blog-masthead">
    ...
    <div class="blog-header">
      <div class="container">
        ...
        <p class="lead blog-description" align="center">Prácticas de la Materia de Sistemas Operativos II <br>
  ...
  <div class="row justify-content-between">
    ...
    <div class="alert alert-primary" role="alert">
      ...
      <form action="exito.php" method="post">
        ...
        <br>
        Teléfono<br>
        <input type="text" name="telefono_s" placeholder="Teléfono"
         class="form-control">
        <br><br>
        <input type="submit" value="Enviar" class="btn btn-success">
      </form>
